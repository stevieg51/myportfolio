...
export const ScrolTro = () => {
    return (
        <>
        <div className='scroll min-w-full'>
            <h2> A Little About Me </h2>
             <p className="text-amber-400">Lorem Ipsum is simply dummy text of the printing and typesetting industry. 
    ...
    for 'lorem ipsum' will uncover many web sites still in their infancy.jeen the industry's standard dummy text ever since the 1500s when a
    n unknown printer took a galley of type and scrambled it to make a type specimen book. 
    It has survived not only five centuries, but also the leap into electronic typesetting, 
    remaining essentially unchanged. It was popularised in the 1960s with the release of 
    Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing 
    ...
    content here', making it look like readable English. Many desktop publishing packages
    and web page editors now use Lorem Ipsum as their default model text, and a search 
    for 'lorem ipsum' will uncover many web sites still in their infancy.j </p>
        </div>
        </>
    )
}